...
import { LayoutDashboard, ShoppingCart, Bell, LogOut, ChevronRight } from 'lucide-react';
...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside className={`fixed left-0 top-0 h-screen w-72 bg-brand-dark lg:bg-brand-dark/50 backdrop-blur-2xl border-r border-brand-border/30 flex flex-col z-[70] transition-transform duration-300 lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className="p-8">
          <div className="flex items-center justify-between">
            ...
            <button onClick={onClose} className="lg:hidden p-2 text-brand-secondary hover:text-brand-primary transition-colors">
